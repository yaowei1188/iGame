...
{
	CCSprite *glowSprite = (CCSprite *)p_sprite->getChildByTag(101);
	if (glowSprite == NULL)
	{
		glowSprite = CCSprite::create("particleTexture.png");
		glowSprite->setColor(p_color);
		glowSprite->setTag(101);
	...
	glowSprite->setBlendFunc(blend1);
	...
	CCRepeatForever *repeat1 = CCRepeatForever::create(CCSequence::create(CCFadeTo::create(0.9f, 120),CCFadeTo::create(0.9f, 200),NULL));
