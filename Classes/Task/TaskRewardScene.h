#ifndef __TASK_REWARD_SCENE_H__
#define __TASK_REWARD_SCENE_H__
...
class TaskRewardScene : public MainLayerBase,
...
public:
	...
	CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(TaskRewardScene,create);
