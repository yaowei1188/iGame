...
{
	//	CCB_SELECTORRESOLVER_CCMENUITEM_GLUE(this, "menuBarBtnClicked:", TaskListScene::menuBarBtnClicked);
	return NULL;
}
...
void TaskListScene::tableCellHighlight(CCTableView* table, CCTableViewCell* cell)
{
	CCSprite *sSelected = (CCSprite*)cell->getChildByTag(121);
	sSelected->setVisible(true);
}

void TaskListScene::tableCellUnhighlight(CCTableView* table, CCTableViewCell* cell)
{
	CCSprite *sSelected = (CCSprite*)cell->getChildByTag(121);
...
CCSize TaskListScene::cellSizeForIndex(CCTableView *table, unsigned int idx)
{
...
bool TaskListScene::hasFixedCellSize()
{
	return false;
}
...
CCTableViewCell* TaskListScene::tableCellAtIndex(CCTableView *table, unsigned int idx)
{
	...
	if (!cell) {
		...
		chatBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(TaskListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
		...
		msgBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(TaskListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
		...
		formationBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(TaskListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
		...
		deleteBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(TaskListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
...
//    按下按钮事件回调
void TaskListScene::toolBarTouchDownAction(CCObject * sender , CCControlEvent controlEvent)
{
...
void TaskListScene::deleteEntry(std::string &targetUser)
{
	CCHttpRequest *request = new CCHttpRequest();
	request->setRequestType(CCHttpRequest::kHttpGet);
	request->setResponseCallback(this,callfuncND_selector(TaskListScene::requestFinishedCallback));
