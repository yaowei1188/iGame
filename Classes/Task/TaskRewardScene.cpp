...
CCScene* TaskRewardScene::scene()
{
	...
	do 
	{
		...
		TaskRewardScene *layer = TaskRewardScene::create();
		CC_BREAK_IF(! layer);
...
bool TaskRewardScene::onAssignCCBMemberVariable(CCObject* pTarget, const char* pMemberVariableName, CCNode* pNode)
{
...
SEL_MenuHandler TaskRewardScene::onResolveCCBCCMenuItemSelector(CCObject * pTarget, const char* pSelectorName)
{
	return NULL;
}

SEL_CCControlHandler TaskRewardScene::onResolveCCBCCControlSelector(CCObject *pTarget, const char * pSelectorName) {

	CCB_SELECTORRESOLVER_CCCONTROL_GLUE(this, "buttonClicked:", TaskRewardScene::buttonClicked);
	return NULL;
}


void TaskRewardScene::showTaskInfo()
{
...
void TaskRewardScene::buttonClicked(CCObject * sender , CCControlEvent controlEvent)
{
...
TaskRewardScene::TaskRewardScene()
{
//	mTableView = NULL;
	//    mMainSceneTemp = NULL;
	mTaskList = NULL;
