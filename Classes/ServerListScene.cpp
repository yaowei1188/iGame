...
CCTableViewCell* ServerListScene::tableCellAtIndex(CCTableView *table, unsigned int idx)
{
	...
	if (!cell) {
        ...
        chatBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(ServerListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
        ...
        msgBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(ServerListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
        ...
        formationBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(ServerListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
        ...
        deleteBtn->addTargetWithActionForControlEvents(this, cccontrol_selector(ServerListScene::toolBarTouchDownAction), CCControlEventTouchUpInside);
...
//    按下按钮事件回调
void ServerListScene::toolBarTouchDownAction(CCObject * sender , CCControlEvent controlEvent)
{
...
void ServerListScene::didClickButton(CCMessageDialog* dialog,unsigned int index)
{
	if (index == 0)
	{
...
void ServerListScene::deleteEntry(std::string &targetUser)
{
	CCHttpRequest *request = new CCHttpRequest();
	request->setRequestType(CCHttpRequest::kHttpGet);
	request->setResponseCallback(this,callfuncND_selector(ServerListScene::requestFinishedCallback));
